...
TRAIN_TAR_FILES=${TARRED_PATH}/train/batches.tokens.16000._OP_1..71_CL_.tar
TRAIN_METADATA=${TARRED_PATH}/train/metadata.json
VALID_SRC=${TEXT_PATH}/newstest2013.en
