export nemo_path=$(pwd) \
  ...
  && export data_path=/workspace/mydatasets/wmt18 \
  && export bi_path=/workspace/mydatasets/wmt18/parallel_clean \
  && export par_train_src=${bi_path}/train.clean.filter.en.shuffled \
  && export par_train_ref=${bi_path}/train.clean.filter.de.shuffled \
  && export bt_path=/workspace/mydatasets/wmt18/en_de_with_backstranslation_not_full_6.12.2020 \
