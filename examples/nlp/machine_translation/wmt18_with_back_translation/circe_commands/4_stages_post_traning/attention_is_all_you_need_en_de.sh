pip3 install -r requirements/requirements.txt \
  ...
  && if [ "$1" -eq "0" ]; then
      ...
      && if [ ! -f ${stage0_dir}/best.ckpt ]; then
          cat ${bi_path}/train.clean.en >"${stage0_dir}/originals.txt" \
          && cat ${bi_path}/train.clean.de >"${stage0_dir}/translations.txt" \
  ...
  && if [ ! -f ${stage1_dir}/best.ckpt ]; then
      cat ${bi_path}/train.clean.en ${mono_data_path}/3M_de_mono_partially_translated_06.12.20/translations.txt >"${stage1_dir}/originals.txt" \
      && cat ${bi_path}/train.clean.de ${mono_data_path}/3M_de_mono_partially_translated_06.12.20/originals.txt >"${stage1_dir}/translations.txt" \
  ...
  && if [ ! -f ${stage2_dir}/best.ckpt ]; then
      cat ${bi_path}/train.clean.en ${mono_data_path}/6M_de_mono_partially_translated_06.12.20/translations.txt >"${stage2_dir}/originals.txt" \
      && cat ${bi_path}/train.clean.de ${mono_data_path}/6M_de_mono_partially_translated_06.12.20/originals.txt >"${stage2_dir}/translations.txt" \
  ...
  && if [ ! -f ${stage3_dir}/best.ckpt ]; then
      cat ${bi_path}/train.clean.en ${mono_data_path}/12M_de_mono_partially_translated_06.12.20/translations.txt >"${stage3_dir}/originals.txt" \
      && cat ${bi_path}/train.clean.de ${mono_data_path}/12M_de_mono_partially_translated_06.12.20/originals.txt >"${stage3_dir}/translations.txt" \
  ...
  && if [ ! -f ${stage4_dir}/best.ckpt ]; then
      cat ${bi_path}/train.clean.en ${mono_data_path}/24M_de_mono_partially_translated_06.12.20/translations.txt >"${stage4_dir}/originals.txt" \
      && cat ${bi_path}/train.clean.de ${mono_data_path}/24M_de_mono_partially_translated_06.12.20/originals.txt >"${stage4_dir}/translations.txt" \
